...
// const imageArray = userData.map(createUserPhoto);
// const nameArray = userData.map(createUserName);
// const infoArray = userData.map(createUserInfo);

// root.append(...imageArray, ...nameArray, ...infoArray,);
